...
class CaloriesRoutesTest {
  ...
  private val testMeta =
      UserMetadata(
          id = "meta-1", userId = "user-1", timestamp = Instant.parse("2025-04-28T12:00:00Z"))
  private val testData = CaloriesData(meta = testMeta, calories = 250.0)
  ...
  fun `POST calories with valid body returns OK`() {
    ...
    withTestApplication({
      ...
      val call =
          handleRequest(HttpMethod.Post, "/api/statistics/calories") {
